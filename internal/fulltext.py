...
class SearchQuerySet(models.query.QuerySet):
    ...
    def get_query_set(self, query, columns, mode):
        ...
        # source https://stackoverflow.com/questions/28278150/mysql-efficient-search
        # -with-partial-word-match-and-relevancy-score-fulltext
        like_query = " ".join([f"{q}*".replace("+", "+*") for q in query.split(" ")])
        return self.extra(where=[where_expression], params=[f"({like_query}) ('{query}')"])
    ...
    def search(self, query, fields=None, mode=None):
        ...
        """
        #
        # Get all required attributes and initialize our empty sets.
        #
